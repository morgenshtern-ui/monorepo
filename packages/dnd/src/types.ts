...
export type ImpactLocation = CombineImpact | ReorderImpact
...
export type State =
  CollectingState | DraggingState | DropAnimatingState | DropPendingState | IdleState

export type StateWhenUpdatesAllowed = CollectingState | DraggingState

export type Announce = (message: string) => void

export type InOutAnimationMode = 'close' | 'none' | 'open'
