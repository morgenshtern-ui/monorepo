...
import type { Arrayable, Nillable } from './types.js'
 ...
 * @category Array
 */
export function toArray<T>(array?: Nillable<Arrayable<T>>): Array<T> {
  array ??= []
 ...
 * @category Array
 */
export function flattenArrayable<T>(array?: Nillable<Arrayable<Arrayable<T>>>): Array<T> {
 ...
 * @category Array
 */
export function mergeArrayable<T>(...args: Nillable<Arrayable<T>>[]): Array<T> {
