/* eslint-disable ts/prefer-reduce-type-parameter */
...
import type { DeepMerge } from './types.js'
...
export function objectKeys<T extends object>(obj: T) {
  return Object.keys(obj) as Array<`${keyof T & (boolean | number | string | null | undefined)}`>
}
